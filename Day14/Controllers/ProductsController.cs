...
public class ProductsController : ControllerBase
{
    ...
    [HttpGet] // curl -s -X GET 'http://localhost:5002/api/products' | jq
    ...
    [HttpPost] // curl -s -X POST 'http://localhost:5002/api/products' -H 'Content-Type: application/json' -d '{"name":"test","price":100,"stock":10,"category":"test"}' | jq
